...
from parser.menu_parser import parse_menu_from_pdf
load_dotenv()

async def process_menu_pdf(file: UploadFile):
    """
    Orchestrates the flow: Receive PDF -> Save Temp -> Parse (Gemini) -> Save to DB.
    """
    tmp_path = None
    ...
    try:
        ...
        logger.info("Parsing Menu PDF with Gemini...")
        
        parsed_schedule = parse_menu_from_pdf(tmp_path)
