    ...
    public partial class AddMajorsAndToolboxesSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                VALUES 
                    (1, 'Bioinformatics and Computational Intelligence', 1, 'бум'),
                    (2, 'Cyber-security and Communication Networks', 1, 'йде'),
                    (3, 'Digital Transformation and Data Analytics', 1, 'ьлад')
